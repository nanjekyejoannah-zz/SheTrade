...
if(isset($_POST['login'])){
	...
	$sql="SELECT * FROM members WHERE Email='$username' and Password='$pass'";
	...
	if($count==1){
		...
		$_SESSION['Avatar']=$newArray['Image_Thumb'];
...
<title>Login | She Trade | All about Women ownen Businesses and More</title>
      ...
      <tr>
        ...
        <div>
			...
			if(isset($_GET['unsuccessful'])){
				...
				echo "<alart>Login Unsuccessful... Please check your Email and/or Password and try again!</alart>";
				...
				echo "<h1>Logout</h1>";
				echo "<alart>You have been successfully loged out!</alart>";
			}elseif(isset($_GET['member'])){
				echo "<h1>Access Denied</h1>";
				echo "<alart>You tried accessing a page you dont have rights to access... Login and try again!</alart>";
			}elseif(isset($_GET['home'])){
				echo "<h1>Login Or <a href=\"register.php\">Create Account</a></h1>";
				echo "<alart>Login or <a href=\"register.php\">Create your Free Account</a> to access your Home Page</alart>";
			}elseif(isset($_GET['account'])){
				echo "<h1>Login Or <a href=\"register.php\">Create Account</a></h1>";
				echo "<alart>Login or <a href=\"register.php\">Create your Free Account</a> to access your Account</alart>";
			}else{
				echo "<h1>Login</h1>";
				echo "<p>Welcome to She Trade the one stop center for Women owned Businesses. Login or Create an account to view, connect and share fun with   your Women traders.</p>";	
			}
            ...
            <table width="600" border="0" cellpadding="2" cellspacing="2">
              ...
              <tr>
                ...
                <td><label for="username"></label>
                  <input name="username" type="text" id="username" size="60" /></td>
                </tr>
              <tr>
                <td>Password</td>
                <td><label for="password"></label>
                  <input name="password" type="password" id="password" size="60" /></td>
                </tr>
              <tr>
                <td height="64">&nbsp;</td>
                <td><input name="button" type="submit" class="download" id="button" value="Log In" /></td>
                </tr>
              <tr>
                <td height="64" colspan="2"><a href="">Forgot Password?</a><br /><br /><a href="register.php">Create an Accout</a> and Join the Fun!!!</td>
                </tr>
              </table>
              </form>
            <p></p>
