...
<title>Verify Products | All about Animals and More</title>
    ...
    <td><table width="723" border="0" align="right" bgcolor="#FFFFFF">
      <tr>
		...
		if(isset($_GET['verify'])){
			echo "<p><center>";
			mysql_query("UPDATE product SET Verified='Yes' WHERE Product_ID='$_GET[verify]'", $conn);
			echo "<alart>Product Successfully Varified</alart><br>";
			...
			if(isset($_GET['member'])){
				...
				$msg .= "Your product has been Verified\n";
				$msg .= "Its available to all site visitors at the link; \n";
				$msg .= "http://www.animalminute.com/details.php?product=$_GET[verify]\n\n";
				
				//$msg .= "You can edit it at(after you login);\n";
				//$msg .= "www.ugautos.com/car/edit.php?id=$_GET[id]\n";
				
				$msg .= "View a list of your products that have not yet been verified:\n";
				$msg .= "http://www.animalminute.com/notverified.php?view=products\n\n";
				
				
				$msg .= "_______________________________\n";
				$msg .= "Animal Minute Uganda\n";
				$msg .= "http://www.animalminute.com/\n";
		...
		while ($newArray = mysql_fetch_array($result)) {
			...
			if ($Product_ID!=""){
				...
				echo "<table width=\"100%\" border=\"0\">";
				  ...
				  echo "<tr>";
					echo "<td>&nbsp;</td>";
					echo "<td><a href=\"verifyproducts.php?page=$page&verify=$Product_ID&member=$Added_By\">Verify</a></td>";
				  echo "</tr>";
				  echo "<tr>";
					echo "<td>Added by</td>";
			...
			if ($page==1){
				...
				$prev=$page-1;
				echo "<a href='verifyproducts.php?page=$prev'>Prev</a>";
			}
			echo " | ";
			if ($page==$total_pgs){
				echo "Next";
				...
				$next=$page+1;
				echo "<a href='verifyproducts.php?page=$next'>Next</a>";	
			}
			echo " | ";
			//echo "Prev | Next | ";
			for ($i=1; $i<=$total_pgs; $i++) { 
				if($page==$i){
					...
					echo "<a href='verifyproducts.php?page=".$i."'>".$i."</a> "; 
				}
			}
			}
