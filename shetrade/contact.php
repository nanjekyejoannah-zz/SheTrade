...
<title>Contact |SHE Trade | All Women Owned Businesses</title>
...
<table width="974" border="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td><div  id="templatemo_menu">
      ...
      <li><a href="contact.php" class="selected">Contact</a><br style="clear: left" />
      </li>
          </ul>
      </div>
    ...
    <td><table width="723" border="0" align="right" bgcolor="#FFFFFF">
      <tr>
        <td width="722"><div id="content" class="float_r">
          ...
          <?php 
            $Contact_Sql = "SELECT Email, Phone, Forward_Emails_To FROM contacts WHERE Contacts_ID=1";
            $result = mysql_query($Contact_Sql, $conn) or die(mysql_error());
            $newArray = mysql_fetch_array($result);
            $Phone = $newArray['Phone'];
            $Email = $newArray['Email'];
			$Forward_Emails_To = $newArray['Forward_Emails_To'];
            //Forward_Emails_To
            ?>
          <div class="content_half float_l">
			...
			if(isset($_POST['sendmail'])){
				echo "<b>";
				if($_POST['author']==''){
					echo"<alart>Please Enter your Name</alart><br/>";
					$error++;
				}
				if($_POST['email']==''){
					echo"<alart>Please Enter your Email</alart><br/>";	
					$error++;
				}
				if($_POST['message']==''){
					echo"<alart>Please Enter a Message</alart><br/>";
					$error++;	
				}
				if($error>=1){
					echo"<br/><alart_next>To Try Again, Click <a href=\"contact.php\"><strong>Here</strong></a></alart_next><br/>";
					//Display errors and Message box again
					}
				else{
					//Send mail Here
					$subject = "$_POST[subject] - Site Message";
					$mailheaders = "From: $_POST[author] <$_POST[email]>";
					$recipient = "$Forward_Emails_To";
					$msg = "Name: $_POST[name]\n";
				...
				echo "<h4>Send us a message now!</h4>";
			}
			?>
            <p>&nbsp;</p>
            <div id="contact_form">
              <form action="contact.php" method="post" name="contact" id="contact">
                ...
                <input type="text" id="author" name="author" class="required input_field" <?php if(isset($_SESSION['Full_Name'])){echo "value=\"$_SESSION[Full_Name]\" ";}?>/>
                <div class="cleaner h10"></div>
                <label for="email">Email*:</label>
                <input type="text" id="email" name="email" class="validate-email required input_field" <?php if(isset($_SESSION['Email'])){echo "value=\"$_SESSION[Email]\" ";}?> />
                <div class="cleaner h10"></div>
          ...
          <div class="content_half float_r">
            ...
            physical address<br />
            <br />
            <strong>Phone:</strong> +256776690539<br />
            <strong>Email:</strong>dfwAfrica@gmail.com<br />
