...
<title>Booking | SHE Trade | All Women Owned Businesses</title>
    ...
    <td><table width="723" border="0" align="right" bgcolor="#FFFFFF">
      <tr>
        <td width="722"><div id="content" class="faq float_r">
          ...
          <h3>&nbsp;</h3>
          <table width="528" border="0" class="input_field">
            <tr>
              <td width="217">Name</td>
              <td width="295"><label for="textfield"></label>
                <input name="textfield" type="text" class="submit_btn" id="textfield" size="50" /></td>
            </tr>
            <tr>
              <td>Email</td>
            ...
            <tr>
              <td>&nbsp;</td>
              <td><input name="button" type="submit" class="download" id="button" value="Submit" /> <input name="button2" type="reset" class="download" id="button2" value="Reset" /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
