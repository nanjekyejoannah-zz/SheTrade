...
<title>Manage Resources | All about Animals and More</title>
  ...
  <tr>
    <td><table width="723" border="0" align="right" bgcolor="#FFFFFF">
      <tr>
        ...
        <?php 
		if(isset($_GET['view']) && $_GET['view']=="cat"){
		?>	
			<h1>Categories</h1>
            <?php
			echo "<center>";
			if(isset($_GET['remove'])){
				$Delete_Cat=mysql_query("DELETE FROM `animal_minute`.`resource_category` WHERE `resource_category`.`Category_ID` = $_GET[remove]", $conn);
				echo "<alart>Category <em><strong>$_GET[name]</strong></em> Deleted!!</alart>";
			}
			echo "</center>";
			
            $sql = "SELECT Category_ID, Category FROM resource_category";
            $result = mysql_query($sql, $conn) or die(mysql_error());
			echo "<p>";
			echo "<table width=\"75%\" border=\"0\">";
			echo "<tr>";
			echo "<td width=\"75%\"><strong>Category:</strong></td>";
			echo "<td width=\"25%\"><strong>Actions</strong></td>";
		  	echo "</tr>";
            while ($newArray = mysql_fetch_array($result)) {
                ...
                if ($Category_ID!=""){
					...
					echo "<tr>";
					echo "<td>$Category</td>";
					echo "<td><a href=\"manageresources.php?view=cat&remove=$Category_ID&name=$Category\">Delete</a></td>";
					echo "</tr>";
            ...
            <div class="cleaner"></div>
            <blockquote>Show <a href="manageresources.php">Resources</a></blockquote>
		<?php
		}else{
		?>
        	<h1>Resources</h1>
			...
			if(isset($_GET['delete'])){
				$Delete_Res=mysql_query("DELETE FROM `animal_minute`.`resource` WHERE `resource`.`Resource_ID` = $_GET[delete]", $conn);
				echo "<alart>Resource <em><strong>$_GET[res]</strong></em> Deleted!!</alart>";
			}
			echo "</center>";
            ...
            while ($newArray = mysql_fetch_array($result)) {
                ...
                if ($Resource_ID!=""){
                    ...
                    echo "<table width=\"100%\" border=\"0\">";
					  echo "<tr>";
						echo "<td colspan=\"2\"><a href=\"details.php?resource=$Resource_ID\"><strong>$Resource</strong></a></td>";
						echo "</tr>";
					  echo "<tr>";
						echo "<td width=\"75%\"><strong>Category:</strong>&nbsp;&nbsp;$Category</td>";
						echo "<td width=\"25%\"><a href=\"#\">Edit Resource</a></td>";
					  echo "</tr>";
					  echo "<tr>";
						echo "<td><strong>Link:</strong>&nbsp;&nbsp;$Link</td>";
						echo "<td><a href=\"manageresources.php?page=$page&delete=$Resource_ID&res=$Resource\"><alart>Delete Resource</alart></a></td>";
					  echo "</tr>";
					echo "</table>";
                    echo "<br /><hr />";
                    echo "</p>";
                ...
                if ($page==1){
                    ...
                    $prev=$page-1;
                    echo "<a href='manageresources.php?page=$prev'>Prev</a>";
                }
                echo " | ";
                if ($page==$total_pgs){
                    echo "Next";
                    ...
                    $next=$page+1;
                    echo "<a href='manageresources.php?page=$next'>Next</a>";	
                }
                echo " | ";
                //echo "Prev | Next | ";
                for ($i=1; $i<=$total_pgs; $i++) { 
                    if($page==$i){
                        ...
                        echo "<a href='manageresources.php?page=".$i."'>".$i."</a> "; 
                    }
                }
                }
            ...
            <div class="cleaner"></div>
            <blockquote>Show <a href="manageresources.php?view=cat">Categories</a></blockquote>
        <?php
		}
		?>
