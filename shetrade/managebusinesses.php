...
<title>Manage Businesses | All about Women Owned businesses and More</title>
...
<table width="974" border="0" bgcolor="#FFFFFF">
        ...
        <table width="954" border="0" align="left">
          <tr>
            ...
            <td width="915"><div id="site_title">
              <h1><a href="http://www.mediaminutes.net/shetrade">She Trade | All about Businesses  and More</a></h1>
            </div></td>
  ...
  <tr>
    <td><div  id="templatemo_menu">
      ...
      if($All_Animals!=0){
          echo "<li class=\"level0 nav-2 parent\" id=\"nav\"> <a href=\"listing.php?businesses\"><span>Businesses</span></a>";
          echo "<ul class=\"level0 mm-2 total-8 rem-1\">";
  ...
  <tr>
    <td><table width="723" border="0" align="right" bgcolor="#FFFFFF">
      <tr>
		...
		$sql = "SELECT Animals_ID, Animal, Breed, Image_1, Price, Added_By FROM animal WHERE Verified='Yes' LIMIT $start_from, $max_results";
		...
		while ($newArray = mysql_fetch_array($result)) {
			...
			if ($page==1){
				...
				$prev=$page-1;
				echo "<a href='managebusinesses.php?page=$prev'>Prev</a>";
			}
			echo " | ";
			if ($page==$total_pgs){
				echo "Next";
				...
				$next=$page+1;
				echo "<a href='managebusinesses.php?page=$next'>Next</a>";	
			}
			echo " | ";
			//echo "Prev | Next | ";
			for ($i=1; $i<=$total_pgs; $i++) { 
				if($page==$i){
					...
					echo "<a href='managebusinesses.php?page=".$i."'>".$i."</a> "; 
				}
			}
			}
