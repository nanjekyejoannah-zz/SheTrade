...
--
-- Host: localhost
-- Generation Time: Aug 09, 2015 at 04:13 PM
...
--
CREATE DATABASE `animal_minute` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `animal_minute`;
...
INSERT INTO `animal` (`Animals_ID`, `Animal`, `Breed`, `Date_of_Birth`, `Parentage`, `Color`, `Vaccinated`, `Registered`, `Trained`, `Weight`, `Purpose`, `Location`, `Country`, `Price`, `Sale_Type`, `Description`, `Image_1`, `Image_1_Thumb`, `Image_2`, `Image_2_Thumb`, `Image_3`, `Image_3_Thumb`, `Views`, `Verified`, `Added_By`, `Member_Type`) VALUES
(1, 'Cattle', 'Jersey', '2012-01-01', 'Not Aware', 'White, Brown, ', 'Yes', 'Yes', 'No', '220', '', '', 'Uganda', '340', 'Negotiable', 'Trial Cow', 'images/animals/Image_1_1_1.jpg', 'images/animals/Thumb_1_1_1.jpg', 'images/animals/no_image.jpg', '', 'images/animals/no_image.jpg', '', 594, 'Yes', 1, 'User'),
(2, 'Cattle', 'Africander', '2012-01-01', 'Artificial Insemination', 'White, Brown, ', 'Yes', 'Yes', 'Not Aware', '700', 'Dual', 'Kampala, Uganda', 'Uganda', '500', 'Fixed Price', 'Power machine', 'images/animals/Image_2_1_1.jpg', 'images/animals/Thumb_2_1_1.jpg', 'images/animals/Image_2_1_2.jpg', 'images/animals/Thumb_2_1_2.jpg', 'images/animals/no_image.jpg', '', 677, 'Yes', 2, 'User');
...
(1, 'Animal Minute Uganda', 'P. O. Box 30469, Kampala, Uganda', 'info@animalminute.com', '', '+256702678067 ');
...
INSERT INTO `product` (`Product_ID`, `Animal`, `Product`, `Price`, `Sale_Type`, `Quantity`, `Description`, `Image`, `Image_Thumb`, `Views`, `Added_By`, `Member_Type`, `Verified`) VALUES
(1, 'Poultry', 'Eggs', '1', 'Negotiable', '60 Trays', '', 'images/products/Image_3_1_1.jpg', 'images/products/Thumb_3_1_1.jpg', 438, 3, 'User', 'Yes');
