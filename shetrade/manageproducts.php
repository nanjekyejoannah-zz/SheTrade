...
<title>Manage Products | All about Animals and More</title>
  ...
  <tr>
    <td><table width="723" border="0" align="right" bgcolor="#FFFFFF">
      <tr>
		...
		$sql = "SELECT Product_ID, Animal, Product, Price, Image, Added_By FROM product WHERE Verified='Yes' LIMIT $start_from, $max_results";
		...
		while ($newArray = mysql_fetch_array($result)) {
			...
			if ($page==$total_pgs){
				...
				$next=$page+1;
				echo "<a href='manageproducts.php?page=$next'>Next</a>";	
			}
			echo " | ";
			//echo "Prev | Next | ";
			for ($i=1; $i<=$total_pgs; $i++) { 
				if($page==$i){
					...
					echo "<a href='manageproducts.php?page=".$i."'>".$i."</a> "; 
				}
			}
			}
