...
<title>Home | All about Women owned businesses  and More</title>
  ...
  <tr>
    <td><table width="723" border="0" align="right" bgcolor="#FFFFFF">
      <tr>
        ...
        <h1>Welcome <a href="details.php?member=<?php echo $_SESSION['Member_ID'];?>"><u><?php echo $_SESSION['Full_Name'];?>!</u></a></h1>
        <table width="100%" border="0">
          <tr>
            <td width="10%" valign="top" align="center"><a href="account.php"><img name="" src="images/edit.png" width="48" height="48" alt="" /></a></td>
            <td width="40%"><a href="account.php"><strong>Edit Account</strong></a><br />View & update your details</td>
            <td width="10%" valign="top" align="center"><a href="addanimal.php"><img name="" src="images/Plus.png" width="48" height="48" alt="" /></a></td>
            <td width="40%"><a href="addbusiness.php"><strong>Add Business</strong></a><br />Add Business or Product to the Inventory.</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            <td valign="top" align="center"><a href="account.php#resetpassword"><img name="" src="images/password.png" width="48" height="48" alt="" /></a></td>
            <td><a href="account.php#resetpassword"><strong>Change Password</strong></a><br />Change your Password</td>
            <td  valign="top" align="center"><a href="mylisting.php"><img name="" src="images/list_2.png" width="48" height="48" alt="" /></a></td>
            <td><a href="mylisting.php"><strong>Products/Business List</strong></a><br />View a list of the Businesses or Products that you advertise, Edit or Delete them.</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            <td valign="top" align="center"><a href="#"><img name="" src="images/delete.png" width="48" height="48" alt="" /></a></td>
            <td><strong>Delete Account</strong><br />Delete your Account and all the Products and Businesses.</td>
            <td valign="top" align="center"><a href="notverified.php?animal"><img name="" src="images/list.png" width="48" height="48" alt="" /></a></td>
            <td><a href="notverified.php?animal"><strong>Not Yet Verified</strong></a><br />View list of Businesses/Products that are not yet Verified by Site Administrator(s)</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        ...
        <hr />
        <?php 
		if($_SESSION['Type']=="Admin" || $_SESSION['Type']=="Orion"){
        ...
        <table width="100%" border="0">
          <tr>
            <td width="10%" valign="top" align="center"><a href="verifybusinesses.php"><img name="" src="images/animal.png" width="48" height="48" alt="" /></a></td>
            <td width="40%"><a href="verifybusinesses.php"><strong>Verify Businesses</strong></a><br />Verify Businesses that were recently uploaded</td>
            <td width="10%" valign="top" align="center"><a href="verifyproducts.php"><img name="" src="images/add.png" width="48" height="48" alt="" /></a></td>
            <td width="40%"><a href="verifyproducts.php"><strong>Verify Products</strong></a><br />Verify Products that were recently uploaded</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            <td valign="top" align="center"><a href="managebusinesses.php"><img name="" src="images/Lamb.png" width="48" height="48" alt="" /></a></td>
            <td><a href="managebusinesses.php"><strong>Manage Businesses </strong></a><br />View, Modify and/or Delete Businesses from the System</td>
            <td  valign="top" align="center"><a href="manageproducts.php"><img name="" src="images/product.png" width="48" height="48" alt="" /></a></td>
            <td><a href="manageproducts.php"><strong>Manage Products</strong></a><br />View, Modify and/or Delete Products from the System</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            <td valign="top" align="center"><a href="addresource.php"><img name="" src="images/Plus.png" width="48" height="48" alt="" /></a><a href="managemembers.php"></a></td>
            <td><a href="addresource.php"><strong>Add Resources</strong></a><br />Add Resourecs to Site.</td>
            <td valign="top" align="center"><a href="manageresources.php"><img name="" src="images/all.png" width="48" height="48" alt="" /></a></td>
            <td><a href="manageresources.php"><strong>Manage Resources</strong></a><br />View, Modify and/or Delte Resources</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
           ...
           <tr>
            <td valign="top" align="center"><a href="managemembers.php"><img name="" src="images/member.png" width="48" height="48" alt="" /></a></td>
            <td><a href="managemembers.php"><strong>Manage Members</strong></a><br />View, Modify and/or Delte Members.</td>
            <td valign="top" align="center"><a href="settings.php"><img name="" src="images/details_2.png" width="48" height="48" alt="" /></a></td>
            <td><a href="settings.php"><strong>Site Settings & Contact Details</strong></a><br />View & Update Site Contact Details</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
		...
		?>
            ...
            <ul class="templatemo_list">
                <li>Business/Products Added</li>
                <li>Currently On Site</li>
                <li>Noy Yet Verified</li>
                <li>Reported</li>
            </ul>
            <!--
            <h3>Heading Three</h3>
      ...
      <div id="templatemo_footer2">
        ...
        <div class="col one_fourth">
          <table width="227" border="0" align="left">
            ...
            <tr>
              <td><div class="fb-like" data-href="http://www.facebook.com/dwfoundationafrica" data-send="true" data-width="220" data-show-faces="true"></div></td>
              </tr>
            </table>
          <h4>&nbsp;</h4>
          </div>
