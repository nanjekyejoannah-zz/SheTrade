      ...
      <tr>
        ...
        <h2>Heading two</h2>
            ...
            <table width="100%" border="1">
              <tr>
                <td width="120" rowspan="4" valign="top" align="center"><img name="" src="" width="120" height="89" alt="" /></td>
                <td width="348">Animal / Breed</td>
                <td width="200">&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
            ...
            <table width="100%" border="1">
              ...
              <tr>
                <td width="473">Type:</td>
                <td width="201">Edit Resource</td>
              </tr>
              <tr>
                <td>Link:</td>
  ...
  <tr>
    <td><div id="templatemo_footer">
      <div id="templatemo_footer2">
        ...
        Copyright © 2015 <a href="#">SHE Trade</a></div>
      <p>&nbsp; </p>
      <p><a href="index.php">Home</a> | <a href="listing.php">Listing</a> | <a href="about.php">About</a> | <a href="terms.php">Terms of Use</a> | <a href="privacy.php">Privacy Policy</a> | <a href="contact.php">Contact</a> </p>
