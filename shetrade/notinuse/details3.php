    ...
    <table width="723" border="0" align="right" bgcolor="#FFFFFF">
      <tr>
        <td width="722"><div id="content" class="float_r">
          <h1>Title Full Name</h1>
          <div class="content_half float_l"> 
            <p align="center"><a  rel="lightbox[portfolio]" href="images/product/10_l.jpg"><img src="images/product/10.jpg" alt="Image 01" width="340" height="300" /></a></p>
          </div>
