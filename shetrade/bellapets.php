...
<table width="974" border="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td><img src="images/bellapets.png" alt="bella pets" width="600" height="200" align="middle" /></td>
  </tr>
  <tr>
    <td><table width="723" border="0" align="right" bgcolor="#FFFFFF">
      <tr>
        <td width="722"><div id="content" class="float_r">
          <h1>Bella Pets          </h1>
          <div class="product_box"> <a href="productdetail.php"><img src="images/product/04.jpg" alt="Image 04" /></a>
            <h3>Dog</h3>
            <p class="product_price">$ 260</p>
            <a href="shoppingcart.php" class="add_to_card">By Bella</a> <a href="productdetail.php" class="detail">Detail</a> </div>
          <div class="product_box"> <a href="productdetail.php"><img src="images/product/05.jpg" alt="Image 05" /></a>
            <h3>Rabit</h3>
            <p class="product_price">$ 80</p>
            <a href="shoppingcart.php" class="add_to_card">By Bella</a> <a href="productdetail.php" class="detail">Detail</a> </div>
          <div class="product_box no_margin_right"> <a href="productdetail.php"><img src="images/product/06.jpg" alt="Image 06" /></a>
            <h3>Cattle</h3>
            <p class="product_price">$ 193</p>
            <a href="shoppingcart.php" class="add_to_card">By Bella</a> <a href="productdetail.php" class="detail">Detail</a> </div>
          <div class="product_box"> <a href="productdetail.php"><img src="images/product/07.jpg" alt="Image 07" /></a>
            <h3>Birds<a href="http://jigsaw.w3.org/css-validator/check/referer" rel="nofollow"><strong></strong></a>.</h3>
            <p class="product_price">$ 30</p>
            <a href="shoppingcart.php" class="add_to_card">By Bella</a> <a href="productdetail.php" class="detail">Detail</a> </div>
          <div class="product_box"> <a href="productdetail.php"><img src="images/product/08.jpg" alt="Image 08" /></a>
            <h3>Parrot</h3>
            <p class="product_price">$ 220</p>
            <a href="shoppingcart.php" class="add_to_card">By Bella</a> <a href="productdetail.php" class="detail">Detail</a> </div>
          <div class="product_box no_margin_right"> <a href="productdetail.php"><img src="images/product/09.jpg" alt="Image 09" /></a>
            <h3>Goat</h3>
