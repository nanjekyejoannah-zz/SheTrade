...
<table width="974" border="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td><div  id="templatemo_menu">
      ...
      <!--<li id="nav"> <a href="#category-one" class="selected">  Resources  </a>
  ...
  <tr>
    <td><table width="723" border="0" align="right" bgcolor="#FFFFFF">
      ...
      <table width="230" border="0" align="left">
        ...
        <tr>
          <td><div class="fb-like-box" data-href="http://www.facebook.com/animalminute" data-width="230" data-height="335" data-show-faces="true" data-stream="false" data-header="false"></div></td>
        </tr>
      <?php
