...
<table width="974" border="0" bgcolor="#FFFFFF">
        ...
        <table width="954" border="0" align="left">
          <tr>
            ...
            <td width="915"><div id="site_title">
              <h1><a href="#">Animal Minute | All about Animals and More</a></h1>
            </div></td>
  ...
  <tr>
    <td><div  id="templatemo_menu">
      ...
      <li><a href="#">Services</a>
                    <ul>
                        <li><a href="booking.php">Make an order</a></li>
                        <li><a href="vets.php">Find Biz</a></li>
  ...
  <tr>
    <td><table width="723" border="0" align="right" bgcolor="#FFFFFF">
        ...
        if($Popular_3>0){
            ...
            while ($newArray = mysql_fetch_array($Popular_Result)) {
				...
				if ($Animals_ID!=""){
					...
					echo "Category: <a href=\"details.php?animal=$Animals_ID\">$Breed</a><br />";
      ...
      <tr>
      <td>
      <div class="fb-like-box" data-href="https://www.facebook.com/dwfoundationafrica" data-width="230" data-height="335" data-show-faces="true" data-stream="false" data-header="false"></div>
      </td>
      </tr>	
    </table></td>
  </tr>
    ...
    <td><div id="templatemo_footer">
      <div id="templatemo_footer2">
        ...
        <div class="col one_fourth no_margin_right">
          <h4>Follow Us</h4>
          <div class="footer_social_button"> <a href="http://www.facebook.com/dwfoundationafrica"><img src="images/facebook.png" title="facebook" alt="Facebook" /></a> <a href="#"><img src="images/flickr.png" title="flickr" alt="flickr" /></a> <a href="#"><img src="images/twitter.png" title="twitter" alt="Twitter" /></a> <a href="#"><img src="images/youtube.png" title="youtube" alt="Youtube" /></a></div>
          </div>
        <div class="cleaner"></div>
        </div>
      <p>&nbsp; </p>
